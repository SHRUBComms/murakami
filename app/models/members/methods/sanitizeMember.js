    ...
    if (member) {
      ...
      try {
        if (
          ...
          (user.permissions.members.contactDetails == "commonWorkingGroup" && commonWorkingGroup) ||
      ...
      try {
        if (
          ...
          (user.permissions.members.workingGroups == "commonWorkingGroup" && commonWorkingGroup) ||
      ...
      try {
        if (
          ...
          (user.permissions.members.carbonSaved == "commonWorkingGroup" && commonWorkingGroup) ||
      ...
      if (Object.keys(sanitizedMember).length > 0) {
        ...
        sanitizedMember.contact_preferences_link =
          process.env.PUBLIC_ADDRESS + "/contact-preferences/" + member.member_id;
      } else {
