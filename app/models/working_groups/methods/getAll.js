module.exports = (WorkingGroups, sequelize, DataTypes) => {
	return async () => {
    		const working_groups = await WorkingGroups.findAll({ raw: true });
      		...
      		let working_groups_obj = {};
      		let working_groups_arr = [];
		...
		return { allWorkingGroupsObj: working_groups_obj, allWorkingGroupsArray: working_groups, allWorkingGroupsFlat: working_groups_arr }
	}
}
