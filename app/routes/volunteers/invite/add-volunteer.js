...
router.post(
  ...
  async (req, res) => {
    ...
    try {
      ...
      await validateVolunteer(
        { allWorkingGroupsFlat: allWorkingGroupsFlat, permissions: { volunteers: { add: true } } },
        volunteer,
        { skills, rolesObj, coordinatorsObj, contactMethods }
      );
      ...
      const userInvitedBy = await Users.getById(res.invite.details.user_id, {
