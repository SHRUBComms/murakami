    ...
    if (req.user || tokenValid == true) {
      WorkingGroups.getAll(function(err, allWorkingGroups) {
        ...
        req
          .checkBody(
            "shrubExplained",
            "Please make sure you have explained SHRUB's vision"
          )
          .notEmpty();
        req
          .checkBody(
            "safeSpace",
            "Please make sure you have explained our Safe Space policy"
          )
          .notEmpty();
        req
          .checkBody(
            "contactConsent",
            "Please make sure this member has consented to being contacted by email"
          )
          .notEmpty();
        req
          .checkBody(
            "gdprConsent",
            "Please make sure this member has agreed to our privacy policy"
          )
          .notEmpty();
