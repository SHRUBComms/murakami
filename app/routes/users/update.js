...
const sanitizeNotificationPreferences = require(
  rootDir + "/app/controllers/users/sanitizeNotificationPreferences"
);
...
router.post(
  ...
  async (req, res) => {
    try {
      ...
      const updatedUser = { user_id: req.params.user_id, class: req.body.class };
      ...
      if (isUser) {
        const sanitizedNotificationPreferences = await sanitizeNotificationPreferences(
