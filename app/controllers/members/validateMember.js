...
const validateMember = async (loggedInUser, submittedForm, addingMember) => {
  ...
  await Validators.string({ name: "address", indefiniteArticle: "an", value: submittedForm.address }, { required: true, minLength: 0, maxLength: 100 });
  await Validators.string({ name: "phone number", indefiniteArticle: "a", value: submittedForm.phone_no }, { required: false, minLength: 0, maxLength: 14 });
